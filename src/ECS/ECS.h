...
public:
    ...
    /// @param entityId Position of the object to retrieve
...
void Registry::AddComponent(Entity entity, TArgs &&... args) {
    ...
    std::string strComponentId = std::to_string(componentId);
    std::string strComponentPoolSize = std::to_string(componentPool->GetSize());

    Logger::Log("COMPONENT ID = " + strComponentId + " --> POOL SIZE: " + strComponentPoolSize);
}
